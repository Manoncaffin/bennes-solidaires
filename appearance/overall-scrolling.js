...
const containerHomepage = document.getElementById('container_homepage');
...
burgerMenuButton.addEventListener('click', function () {
    burgerMenu.classList.toggle('open');
        ...
        if (burgerMenu.classList.contains('open')) {
            ...
            container.style.display = 'block'; // Afficher le conteneur lorsque le menu burger est fermé
